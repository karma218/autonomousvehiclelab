...
: ${AMENT_CURRENT_PREFIX:="/media/snow/Heavy_Duty/ros2_package/src/camera_mananger/install/camera_mananger"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/camera_mananger/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/camera_mananger/environment/path.sh"
